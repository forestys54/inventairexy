...
app_server <- function(input, output, session) {
  ...
  callModule(mod_rgb_image_server, "rgbmap", rv = r)
  callModule(mod_product_selection_server, "product_selection", rv = r)
  callModule(mod_spectral_indice_server, "indices", rv = r)
  callModule(mod_processing_options_server, "processing_options", rv = r)
  callModule(mod_temporal_map_server, "temporal_map", rv = r)
