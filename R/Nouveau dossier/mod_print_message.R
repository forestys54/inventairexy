...
#' @title   mod_print_message_ui and mod_print_message_server
...
#'
#' @rdname mod_print_message
#'
#' @keywords internal
#' @export 
#' @importFrom shiny NS tagList 
mod_print_message_ui <- function(id){
  ns <- NS(id)
  tagList(
...
mod_print_message_server <- function(input, output, session){
  ns <- session$ns
...
# mod_print_message_ui("print_message_ui_1")
    
## To be copied in the server
# callModule(mod_print_message_server, "print_message_ui_1")
